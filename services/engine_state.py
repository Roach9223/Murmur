...
class EngineState:
    ...
    def to_status_dict(self, app) -> dict:
        ...
        return {
            ...
            "media_hotkey": getattr(app, 'media_hotkey', ''),
            ...
            "loopback_device_index": app.config.cfg.get("loopback_device_index"),
            "loopback_device_name": app.config.cfg.get("loopback_device_name", ""),
            "loopback_devices": AudioCaptureService.enumerate_loopback_devices(),
            "conversation_log_active": app.transcript.active,
            "conversation_log_path": app.transcript.current_path,
